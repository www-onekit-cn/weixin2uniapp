<template>
    <view>
        ...
        <view class="uni-padding-wrap uni-common-mt">
            ...
            <onekit-button type="primary" :loading="loading">页面主操作 Loading</onekit-button>
            ...
            <onekit-button open-type="launchApp" app-parameter="uni-app" @error="openTypeError">打开APP</onekit-button>
            <onekit-button open-type="feedback">意见反馈</onekit-button>
            <!-- #endif -->
        </view>
    </view>
</template>
