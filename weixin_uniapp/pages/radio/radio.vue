<template>
	<view>
		...
		<view class="uni-padding-wrap">
			...
			<view>
				<label class="radio" style="margin-right: 30rpx;">
					<onekit-radio value="r1" checked="true" />选中
				</label>
				<label class="radio">
		...
		<view class="uni-padding-wrap">
			...
			<view>
				<label class="radio" style="margin-right: 30rpx;">
					<onekit-radio value="r1" checked="true" color="#FFCC33" style="transform:scale(0.7)"/>选中
				</label>
				<label class="radio">
					<onekit-radio value="r2" color="#FFCC33" style="transform:scale(0.7)"/>未选中
				</label>
			</view>
		</view>
		...
		<view class="uni-list">
			<onekit-radio-group @change="radioChange">
				<label class="uni-list-cell uni-list-cell-pd" v-for="(item, index) in items" :key="item.value">
					<view>
						<onekit-radio :value="item.value" :checked="index === current" />
					</view>
					<view>{{item.name}}</view>
				</label>
			</onekit-radio-group>
