	...
	<view>
		...
		<view class="uni-list">
			<view class="uni-list-cell">
				...
				<view class="uni-list-cell-db">
					<onekit-picker @change="bindPickerChange" :value="index" :range="array" range-key="name">
		...
		<view class="uni-list">
			<view class="uni-list-cell">
				...
				<view class="uni-list-cell-db">
					<onekit-picker mode="multiSelector" @columnchange="bindMultiPickerColumnChange" :value="multiIndex" :range="multiArray">
