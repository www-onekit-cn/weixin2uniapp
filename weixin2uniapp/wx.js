...
import BackgroundAudioManager from './api/BackgroundAudioManager'
...
export default class wx {
  ...
  //     const wx_token = uni_object.token
  //     const wx_success = uni_object.success
  //     const wx_fail = uni_object.fail
  //     const wx_complete = uni_object.complete
  //     // ///////////////
  //     uni.setStorage({
  //       key: 'wx_token',
  //       data: {
  ...
  static getBackgroundFetchToken(uni_object) {
    const uni_success = uni_object.success
    // const uni_fail = uni_object.fail
    // const uni_complete = uni_object.complete
  ...
  //
  static stopBluetoothDevicesDiscovery() { /* return uni.stopBluetoothDevicesDiscovery(object); */ }

  static startBluetoothDevicesDiscovery(object) {
    return uni.startBluetoothDevicesDiscovery(object)
  }

  static openBluetoothAdapter() { /* return uni.openBluetoothAdapter(object); */ }
  ...
  static startRecord(object) {
    const recorderManager = uni.getRecorderManager(object)
  ...
  static downloadFile(wx_object) {
    ...
    // const wx_timeout = wx_object.timeout
    ...
    uni_object.success = function () {
      ...
      //   for (const uni_res_key in uni_res) {
      //     const uni_res_value = uni_res[uni_res_key]
      //     switch (uni_res_key) {
      //       case 'tempFilePath':
      //         if (wx_res.filePath) {
      //           uni.saveFile({
  ...
  //   const wx_url = wx_object.url
  //   const wx_filePath = wx_object.filePath
  //   const wx_name = wx_object.name
  //   const wx_header = wx_object.header
  //   const wx_timeout = wx_object.timeout
  //   const wx_formData = wx_object.formData
  //   const wx_success = wx_object.success
  //   const wx_fail = wx_object.fail
  //   const wx_complete = wx_object.complete
  //   const uni_object = {}
