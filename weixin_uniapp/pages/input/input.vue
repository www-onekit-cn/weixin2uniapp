        ...
        <view class="uni-common-mt">
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" focus placeholder="自动获得焦点" />
                </view>
            </view>
            <!-- #ifdef APP-PLUS -->
            <view v-if="platform==='ios'&&!isNvue" class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" placeholder="触摸其他地方收起键盘" @focus="onFocus" @blur="onBlur" />
                </view>
            </view>
            <!-- #endif -->
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" confirm-type="search" placeholder="键盘右下角按钮显示为搜索" />
                </view>
            </view>
            <!-- #ifndef H5 -->
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" confirm-type="send" placeholder="键盘右下角按钮显示为发送" />
                </view>
            </view>
            <!-- #endif -->
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" placeholder="最大输入长度为10" />
                </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">实时获取输入值：{{inputValue}}</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" @input="onKeyInput" placeholder="输入同步到view中" />
                </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">控制输入的 input</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" @input="replaceInput" v-model="changeValue" placeholder="连续的两个1会变成2" />
                </view>
            </view>
            <!-- #ifndef MP-BAIDU -->
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" ref="input1" @input="hideKeyboard" placeholder="输入123自动收起键盘" />
                </view>
            </view>
            <!-- #endif -->
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" type="number" placeholder="这是一个数字输入框" />
                </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">密码输入的 input</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" password type="text" placeholder="这是一个密码输入框" />
                </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">带小数点的 input</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" type="digit" placeholder="带小数点的数字键盘" /> </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">身份证输入的 input</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" type="idcard" placeholder="身份证输入键盘" /> </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">控制占位符颜色的 input</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" placeholder-style="color:#F76260" placeholder="占位符字体是红色的" />
                </view>
            </view>
            <view class="uni-form-item uni-column">
                <view class="title"><text class="uni-form-item__title">带清除按钮的输入框</text></view>
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" placeholder="带清除按钮的输入框" :value="inputClearValue" @input="clearInput" />
            ...
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <onekit-input class="uni-input" placeholder="请输入密码" :password="showPassword" />
